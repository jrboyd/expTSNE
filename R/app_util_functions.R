...
#' @param valid_genes character vector of genes to look for
#'
#' @return data.frame with gene names in gene_name var
...
#'
#' @param df data.frame to inspect and modify
#' @param valid_genes character vector of all valid genes
#' @param valid_var var name to add validity logical to
#'
#' @return data.frame with additional variable indicating validity (in valid_var) of genes
